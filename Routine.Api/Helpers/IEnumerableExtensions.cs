...
namespace Routine.Api.Helpers
{
    public static class IEnumerableExtensions
    {
            ...
            (this IEnumerable<TSource> source, string fields)
        {
            ...
            {
                var properInfos = typeof(TSource).GetProperties(BindingFlags.Public | BindingFlags.Instance);
            ...
            else
            {
                ...
                foreach (var field in fieldsAfterSplit)
                {
                    ...
                    var propertyInfo =
                        typeof(TSource).GetProperty(propertyName, BindingFlags.IgnoreCase | BindingFlags.Public | BindingFlags.Instance);
